...
public:
    ...
    //el tama?o de la lista, para que un iterador sepa cuanto debe recorrer
    ...
    //Recibe un iterador, lee esa posicion e inserta un c?digo en la posicion que le demos
